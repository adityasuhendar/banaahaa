    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center px-4 md:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          {portfolioImagesBase.map((img, index) => (
            <div
              key={index}
        ...
        <div className="absolute bottom-6 md:bottom-10 left-1/2 transform -translate-x-1/2 z-10 flex gap-2">
          {portfolioImagesBase.map((_, index) => (
            <button
              key={index}
      ...
      <section className="py-32 px-8 bg-gradient-to-b from-[#0a0a0a] to-black">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-3 bg-[#E6B800] hover:bg-[#F5D76E] text-black px-16 py-6 text-base font-semibold uppercase tracking-wider transition-all rounded-lg"
          >
            Mulai Proyek Anda
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="https://www.instagram.com/banaahaa.arsitektur/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-[#1a1a1a] hover:bg-[#E6B800] transition-all group rounded-lg" aria-label="Instagram">
                  ...
                  <a href="https://www.youtube.com/@BaNaaHaaArchitecture" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-[#1a1a1a] hover:bg-[#E6B800] transition-all group rounded-lg" aria-label="YouTube">
                    <svg className="w-6 h-6 fill-white group-hover:fill-black transition-colors" viewBox="0 0 24 24">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                    </svg>
                  </a>
                  <a href="https://www.tiktok.com/@banaahaa.studioarsitek" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-[#1a1a1a] hover:bg-[#E6B800] transition-all group rounded-lg" aria-label="TikTok">
                    <svg className="w-6 h-6 fill-white group-hover:fill-black transition-colors" viewBox="0 0 24 24">
                      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
                    </svg>
                  </a>
                  <a href="https://web.facebook.com/banaahaa.architectural" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-[#1a1a1a] hover:bg-[#E6B800] transition-all group rounded-lg" aria-label="Facebook">
                    <svg className="w-6 h-6 fill-white group-hover:fill-black transition-colors" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col justify-center gap-6">
              <a
                ...
                className="bg-white hover:bg-gray-200 text-black px-12 py-6 text-base font-semibold uppercase tracking-wider transition-all inline-flex items-center justify-center gap-3 rounded-lg"
              >
              ...
              <a
                ...
                className="border-2 border-white hover:bg-white hover:text-black text-white px-12 py-6 text-base font-semibold uppercase tracking-wider transition-all inline-flex items-center justify-center gap-3 rounded-lg"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
